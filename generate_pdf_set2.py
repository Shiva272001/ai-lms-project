...
def generate_quiz_pdf(filename="quiz_questions_set2.pdf"):
    ...
    quiz_data = [
        {
            "num": 20,
            "q": "The largest and fastest computers are known as <u>supercomputers</u>.",
            "ans": "Supercomputers"
        },
        {
            "num": 21,
            "q": "AI mimics human behavior using domains like Data Science, Natural Language Processing (NLP), and <u>Computer Vision (CV)</u>.",
        ...
        {
            "num": 25,
            "q": "Changing the speed of individual motors allows the drone to generate thrust, move in different directions, or <u>hover in place</u>.",
            "ans": "Hover in place"
        }
    ]
    ...
    story.append(Paragraph("Quiz Questions & Answers (Set 20-25)", title_style))
